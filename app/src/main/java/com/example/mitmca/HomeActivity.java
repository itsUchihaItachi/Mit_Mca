...
public class HomeActivity extends AppCompatActivity implements RecyclerDataAdapter.GridItemListener {
    ...
    private void setupRecyclerView() {
        ...
        RecyclerDataAdapter adapter = new RecyclerDataAdapter(dataList, this);
